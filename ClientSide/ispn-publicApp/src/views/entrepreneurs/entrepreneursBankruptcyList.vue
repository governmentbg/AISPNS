...
export default {
  name: "entrepreneursBankruptcyList",
  components: {
  ...
  mounted() {
    this.table.headers = [
      ...
      { text: this.$t('book_634_v'), value: "customLink", sortable: false, valueType: "customLink", linkName: this.$t('book'), path: '/entrepreneurs/bankruptcy/$$$/book', width: '10%' },
      { text: this.$t('acts_subject_to_appeal'), value: "customLink", sortable: false, valueType: "customLink", linkName: this.$t('acts'), path: '/entrepreneurs/bankruptcy/$$$/acts', width: '10%' },
      { text: this.$t('declared_acts_of_bankruptcy'), value: "customLink", sortable: false, valueType: "customLink", linkName: this.$t('acts'), path: '/entrepreneurs/bankruptcy/$$$/declared-acts', width: '13%' },
      { text: this.$t('bankruptcy_proceedings_data'), value: "customLink", sortable: false, valueType: "customLink", linkName: this.$t('datas'), path: '/entrepreneurs/bankruptcy/$$$/proceedings-data', width: '10%' },
  ...
  methods: {
    ...
    preview(item) {
      this.$router.push({ path: `/entrepreneurs/bankruptcy/${item.id}` });
    },
