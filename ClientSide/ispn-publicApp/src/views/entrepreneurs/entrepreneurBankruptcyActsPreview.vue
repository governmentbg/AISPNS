...
export default {
  ...
  mounted(){
    this.table.headers = [
      { text: this.$t('acts_subject_to_appeal'), value: "act", valueType: 'text', sortable: false },
      { text: this.$t('date_of_announcement_or_entry'), valueType: 'date', value: "date", sortable: false },
      { text: this.$t('appeal_period'), value: "deadline", valueType: 'text', sortable: false },
