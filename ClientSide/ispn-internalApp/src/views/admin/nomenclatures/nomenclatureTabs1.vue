                ...
                <v-card flat class="">
                  <v-card-title class="headline print d-print-flex mb-0">
                    <v-row>
                      ...
                      <v-col cols="12" md="6" class="text-right" v-if="!tab.type">
  ...
  data: () => ({
    ...
    innerTabs: {
      bankruptcy: [
        ...
        { key: 'caseCode', name: 'Шифър на дело' },
        { key: 'incommingDocTypes', name: 'Вид на входящ документ' },
        { key: 'sides', name: 'Участие' },
        ...
        { key: 'templates28directive', name: 'Образци по чл. 28 от Директивата' },
        { key: 'statisticalReportsTypes', name: 'Типове справки и статистики' },
        { key: 'statisticalReportsSources', name: 'Източници на справки и статистики' },
        { key: 'categoryStabilizationBankruptcy', name: 'Категории актове по стабилизация за обявяване' },
        { key: 'categoryActsBankruptcy', name: 'Категории актове по несъстоятелност за обявяване' },
      ],
      syndics: [
        ...
        { key: 'syndicActionTypes', name: 'Вид действие на синдик' },
      ...
      salesAnnouncements: [
        { key: 'pleaTypes', name: 'Правно основание' },
        { key: 'placeOfSell', name: 'Място за продажба' },
        { key: 'orderOfSell', name: 'Ред на продажбата' },
        { key: 'methodOfSell', name: 'Начин на продажбата' },
        { key: 'papersForSell', name: 'Книжа за продажбата' },
        { key: 'processOfSell', name: 'Описание на процеса на продажба' },

        { key: 'restrictionOfParticipating', name: 'Ограничение за участие в продажбата', type: 'field' },
        { key: 'termOfPaymentPrice', name: 'Срок за плащане на цена', type: 'field' },
        { key: 'syndicsCaseReports', name: 'Определяне на последващи купувачи', type: 'field' },
        { key: 'assignment', name: 'Възлагане', type: 'field' },
        { key: 'introductionPassingRisk', name: 'Въвод и преминаване на риска', type: 'field' },
        { key: 'saleUnderSharedOwnership', name: 'Продажба при съсобственост', type: 'field' },
        { key: 'saleOfMortgagedPledgedProperty', name: 'Продажба на ипотекирано или заложено имущество', type: 'field' },
      ]
    },
    currentTab: 0,
    tables: {},
