...
import { apiLogin, apiGetCurrentUserInfo, apiSignOut } from '@/api/account';
...
const actions = {
  ...
  login({ commit, dispatch }, credentials) {
    ...
    return new Promise(async (resolve, reject) => {
      apiLogin({ username: username.trim(), password: password }).then(async response => {
